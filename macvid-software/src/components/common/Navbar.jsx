        ...
        >
          ...
          <div className="flex flex-col h-[calc(100%-80px)] px-6 py-8 overflow-y-auto">
            ...
            <div className="mt-auto pt-8 space-y-4">
              <button className="w-full py-5 bg-white/5 border border-white/10 rounded-2xl font-black text-white text-xs uppercase tracking-widest hover:bg-white/10 transition-all active:scale-95">
                Client Login
              </button>
              <button className="w-full py-5 bg-primary text-white rounded-2xl font-black text-xs uppercase tracking-widest hover:bg-primaryDark transition-all active:scale-95 shadow-xl shadow-primary/20">
                Book a Demo
              </button>
